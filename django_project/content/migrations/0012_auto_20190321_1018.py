...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('content', '0011_partner_partner_type'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='partner',
            name='partner_type',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='Type', choices=[(b'PT', b'PARTNER'), (b'SP', b'SPONSOR'), (b'OT', b'OTHER')]),
        ),
    ]
