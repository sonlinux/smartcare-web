...
then
    ...
    rsync -L  backups/latest.dmp staging.smartcare.edited.com:/home/smartcare-client/deployment/backups/
    rsync -r -v media/ staging.smartcare.edited.com:/home/smartcare-client/deployment/media
	...
	ssh staging.smartcare.edited.com "cd /home/smartcare-client/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
